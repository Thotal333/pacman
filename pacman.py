...
def draw_misc():
    ...
    if game_over:
        ...
        gameover_text = font.render('Game over! Clique em Espaço para recomeçar', True, 'black')
        screen.blit(gameover_text, (100, 300))
    if game_won:
        pygame.draw.rect(screen, 'white', [50, 200, 800, 300],0, 10)
        pygame.draw.rect(screen, 'white', [70, 220, 760, 260], 0, 10)
        gameover_text = font.render('Game won! Clique em Espaço para recomeçar', True, 'green')
        screen.blit(gameover_text, (100, 300))
...
namescore = input('Como deseja que seu nome seja gravado? ')

with open('scorepacman.txt','a') as pontuacao:
    pontuacao.write('\n'+namescore+': '+str(score))
